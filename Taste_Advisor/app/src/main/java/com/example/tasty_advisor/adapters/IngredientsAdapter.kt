...
import com.example.tasty_advisor.models.ExtendedIngredient
import com.example.tasty_advisor.util.Constants.Companion.BASE_IMAGE_URL
...
class IngredientsAdapter: RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.ingredient_textView_name.text = ingredientsList[position].name.capitalize()
